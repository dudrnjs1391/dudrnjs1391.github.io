...
- 이러한 Deep Learning 모형들을 만들기 위한 도구들은 아래와 같이 다양하다.
    ...
    ![](https://dudrnjs1391.github.io/_posts/Prologue 1 Deep Learning Frameworks/prologue-1-0.png)
...
3. **Open Source** : 수 많은 Community와 다양하고 빠른 신기술 적용
    ...
    ![](https://dudrnjs1391.github.io/_posts/Prologue 1 Deep Learning Frameworks/prologue-1-1.png)
...
- **TensorFlow 2.0에서 변한 점**
    ...
    - 즉시 실행(**Eager Execution**) 지원
        ...
        ![](https://dudrnjs1391.github.io/_posts/Prologue 1 Deep Learning Frameworks/prologue-1-2.png)
...
2. **High Speed**: 다른 딥러닝 프레임워크에 비해 빠른 속도
    ...
    ![](https://dudrnjs1391.github.io/_posts/Prologue 1 Deep Learning Frameworks/prologue-1-3.png)

    다른 tool들에 비해 상대적으로 속도가 빠름

3. **Increasing usage**: 점점 증가하고 있는 사용량

![](https://dudrnjs1391.github.io/_posts/Prologue 1 Deep Learning Frameworks/prologue-1-4.png)
